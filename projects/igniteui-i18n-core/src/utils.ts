...
export function generateLocaleKey(locale: string, formatterOptions?: Intl.NumberFormatOptions | Intl.DateTimeFormatOptions) {
 ...
 */
export function mergeOptions<T extends Intl.NumberFormatOptions | Intl.DateTimeFormatOptions>(target: T, source: T = {} as T) {
