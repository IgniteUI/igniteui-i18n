...
export const GridResourceStringsEN: IGridResourceStrings = {
    ...
    grid_required_validation_error: 'This field is required',
    grid_min_validation_error: 'A value of at least {0} should be entered',
    grid_max_validation_error: 'A value no more than {0} should be entered',
    grid_min_length_validation_error: 'Entry should be at least {0} character(s) long',
    grid_max_length_validation_error: 'Entry should be no more than {0} character(s) long',
    grid_email_validation_error: 'A valid email address should be entered',
    grid_pattern_validation_error: 'Entry does not match the required pattern'
};
