...
export const CalendarResourceStringsIT: ICalendarResourceStrings = {
  ...
  calendar_previous_years: 'Precedenti {0} anni',
  calendar_next_years: 'Precedenti {0} anni',
  calendar_select_date: 'Selezionare la data',
  ...
  calendar_range_label_start: 'Inizio',
  calendar_range_label_end: 'Fine',
  calendar_range_placeholder: "Selezionare l'intervallo",
