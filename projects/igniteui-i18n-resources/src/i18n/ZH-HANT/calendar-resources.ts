...
export const CalendarResourceStringsZHHANT: ICalendarResourceStrings = {
  ...
  calendar_previous_year: '去年',
  calendar_next_year: '明年',
  calendar_previous_years: '前 {0} 年',
  calendar_next_years: '後 {0} 年',
  calendar_select_date: '選擇日期',
  calendar_select_month: '選擇月',
  calendar_select_year: '選擇年',
  calendar_range_start: '範圍開始',
  calendar_range_end: '範圍結束',
  calendar_range_label_start: '開始',
  calendar_range_label_end: '結束',
  calendar_range_placeholder: '選擇範圍',
  calendar_selected_month_is: '選擇的月份: ',
